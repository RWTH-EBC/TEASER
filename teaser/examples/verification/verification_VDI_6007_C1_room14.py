"""
This script loads the VDI 6007 C1 Room 14 as *.teaserjson and computes
...
def parameter_room1():
    ...
    prj.load_project(utilities.get_full_path(
        "examples/examplefiles/VDI6007_C1_Room14.json"))

    """
    examples/examplefiles/VDI6007_C1_Room14.json
    examples/examplefiles/VDI6007_C1_Room14_1.json
    """
