...
class EST8a(Residential):
    """Urban Fabric Type EST8a.

    Subclass from Building for urban fabric type EST8a.
    ...
    def __init__(self,
        ...
        super(EST8a, self).__init__(parent, name, year_of_construction,
        ...
        self.est_factor_facade_to_volume = 0.66
