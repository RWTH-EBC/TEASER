...
class RetailMarket(Office):
    ...
    The non-food retail market module contains a multi zone building which is
    based on an office building with additional retail, rooms and kitchen zones.
    ...
    #. Retail department store (80% of net leased area)
    #. Storage (16% of net leased area)
    #. Rooms (4% of net leased area)
    ...
    def __init__(self,
        ...
        """Constructor of RetailMarket

        Adds a additional zones "Retail department store", "Storage" and "Rooms"

        """

        super(RetailMarket, self).__init__(parent,
                                           name,
        ...
        self.height_of_floors = 4.7

        self.est_exponent_wall = 1.0
        self.est_factor_wall_area = 0.83
        self.est_factor_win_area = 0.085
