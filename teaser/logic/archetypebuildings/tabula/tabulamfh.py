...
class TabulaMFH(Residential):
    ...
    construction_type : str
        ...
        tabula_standart_MFH)
            tabula_standart_MFH:
            tabula_refurbished_MFH:
            tabula_advanced_refurbished_MFH:
    ...
    def __init__(
        ...
        self.dict_bak_MFH = {(0, 1859): [1.11, 0.28],
                             (1860, 1918): [0.47, 0.23],
                             (1919, 1949): [0.84, 0.21],
                             (1949, 1957): [0.73, 0.18],
                             (1958, 1968): [0.65, 0.22],
    ...
    def construction_type(self, value):
        if value is not None:
            if value == "tabula_standard_MFH" or \
               value == "tabula_refurbished_MFH" or \
               value == "tabula_advanced_refurbished_MFH":
                self._construction_type = value
            else:
                raise ValueError("Construction_type has to be" +
                                 "tabula_standard_MFH, " +
                                 "tabula_refurbished_MFH or" +
                                 "tabula_advanced_refurbished_MFH")
        else:
            self._construction_type = "tabula_standard_MFH"
