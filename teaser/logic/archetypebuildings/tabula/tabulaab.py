...
class TabulaAB(Residential):
    ...
    construction_type : str
        ...
        "tabula_standart_AB")
            tabula_standart_AB:
            tabula_refurbished_AB:
            tabula_advanced_refurbished_AB:
    ...
    def construction_type(self, value):
        if value is not None:
            if value == "tabula_standard_AB" or \
               value == "tabula_refurbished_AB" or \
               value == "tabula_advanced_refurbished_AB":
                self._construction_type = value
            else:
                raise ValueError("Construction_type has to be" +
                                 "tabula_standard_AB, " +
                                 "tabula_refurbished_AB or" +
                                 "tabula_advanced_refurbished_AB")
        else:
            self._construction_type = "tabula_standard_AB"
