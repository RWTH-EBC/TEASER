...
class TabulaSFH(Residential):
    ...
    construction_type : str
        ...
        "tabula_standart_SFH")
            tabula_standart_SFH:
            tabula_refurbished_SFH:
            tabula_advanced_refurbished_SFH:
    ...
    def __init__(
        ...
        self.dict_bak_SFH = {(0, 1859): [0.78, 0.88],
                             (1860, 1918): [1.37, 0.34],
                             (1919, 1949): [0.78, 0.19],
                             (1949, 1957): [1.06, 0.27],
                             (1958, 1968): [1.24, 0.31],
    ...
    def construction_type(self, value):
        if value is not None:
            if value == "tabula_standard_SFH" or \
               value == "tabula_refurbished_SFH" or \
               value == "tabula_advanced_refurbished_SFH":
                self._construction_type = value
            else:
                raise ValueError("Construction_type has to be" +
                                 "tabula_standard_SFH, " +
                                 "tabula_refurbished_SFH or" + 
                                 "tabula_advanced_refurbished_SFH")
        else:
