...
class InterzonalCeiling(InterzonalWall):
    """InterzonalCeiling (InterzonalWall)

    This class represents an interzonal ceiling and is a child of
    InterzonalWall()
    ...
    InterzonalCeiling of one zone, an InterzonalFloor has to be created for the
    ...
    parent : ThermalZone()
        ...
        adds this InterzonalCeiling to ThermalZone.interzonal_ceilings.
        Default is None.
    ...
    other_side : ThermalZone()
        the thermal zone on the upper side of the interzonal ceiling
    ...
    def __init__(self, parent=None, other_side=None):
        """Constructor InterzonalCeiling (InterzonalWall)

        """
        super(InterzonalCeiling, self).__init__(parent, other_side)
