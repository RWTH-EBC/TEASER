...
class Door(OuterWall):
    """Outer door class

    This class holds information of an entrance door and is a child of
    OuterWall()

    Will be treated exactly as OuterWalls, we need this distinction due to
    Door class in Tabula
