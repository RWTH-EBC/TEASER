...
class InnerTABS(InnerWall):
    """InnerTABS (InnerWall)

    This class represents an internal thermally activated building system and is a child of InnerWall()
    ...
    def __init__(self, parent=None):
        """
        """
        super(InnerTABS, self).__init__(parent)

        self._tilt = 0.0
        self._orientation = -2.0


class OuterTABS(OuterWall):
    """InnerTABS (OuterWall)

    This class represents an external thermally activated building system and is a child of OuterWall()
    ...
    def __init__(self, parent=None):
        """
        """
        super(OuterTABS, self).__init__(parent)
