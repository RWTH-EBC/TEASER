...
class FourElement(object):
    ...
    def __init__(self, thermal_zone, merge_windows, t_bt):
        ...
        self.area_gf = 0.0
        # todo needed? self.factor_nz_gf = 0.0
        ...
        # values related to neighboured zones needed?
        # self.n_nz = 0
    ...
    def _calc_wf(self):
        ...
        if self.merge_windows is True:
            ...
            for rt in self.thermal_zone.rooftops:
                ...
                # todo need to include self.thermal_zone.nz_borders?
    ...
    def set_calc_default(self):
        ...
        # todo values related to neighboured zones needed?
        # self.n_nz = 0
        # self.weightfactor_nz = []
        # self.alpha_conv_outer_nz = []
