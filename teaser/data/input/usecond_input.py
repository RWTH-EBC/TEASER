...
def load_use_conditions(use_cond, zone_usage, data_class):
    ...
    use_cond.lighting_power = conditions_bind[
        zone_usage][
        "lighting_power"]
    use_cond.ratio_conv_rad_lighting = conditions_bind[
        zone_usage]["ratio_conv_rad_lighting"]
    use_cond.use_constant_infiltration = conditions_bind[
        zone_usage]["use_constant_infiltration"]
    use_cond.infiltration_rate = conditions_bind[zone_usage][
        "infiltration_rate"]
    use_cond.max_user_infiltration = conditions_bind[
        zone_usage]["max_user_infiltration"]
    use_cond.max_overheating_infiltration = conditions_bind[
        zone_usage]["max_overheating_infiltration"]
    use_cond.max_summer_infiltration = conditions_bind[
    ...
    use_cond.machines_profile = conditions_bind[
        zone_usage]["machines_profile"]
    use_cond.lighting_profile = conditions_bind[
