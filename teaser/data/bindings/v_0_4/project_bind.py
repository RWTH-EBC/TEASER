...
# Generated 2016-09-28 14:49:43.078650 by PyXB version 1.2.4 using Python 3.5.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:06d48d70-857a-11e6-b0a0-2cd444b2e704')
...
class LightingType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element maintained_illuminance uses Python identifier maintained_illuminance
    __maintained_illuminance = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'maintained_illuminance'), 'maintained_illuminance', '__AbsentNamespace0_LightingType_maintained_illuminance', False, pyxb.utils.utility.Location('D:\\GIT\\pyxb\\scripts\\BoundaryConditions.xsd', 20, 6), )
...
LightingType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'maintained_illuminance'), pyxb.binding.datatypes.float, scope=LightingType, location=pyxb.utils.utility.Location('D:\\GIT\\pyxb\\scripts\\BoundaryConditions.xsd', 20, 6)))
...
def _BuildAutomaton_ ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(LightingType._UseForTag(pyxb.namespace.ExpandedName(None, 'maintained_illuminance')), pyxb.utils.utility.Location('D:\\GIT\\pyxb\\scripts\\BoundaryConditions.xsd', 20, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
