...
print("r1_iw:", prj.list_of_buildings[0].thermal_zones[0].r1_iw, "K/W ---", "Rouvel: 0.003237138 K/W")
print("c1_iw: ", prj.list_of_buildings[0].thermal_zones[0].c1_iw / 1000, "kJ/K ---", "Rouvel: 7297.1 kJ/K")
...
print("r_rest_ow", prj.list_of_buildings[0].thermal_zones[0].r_rest_ow, "K/W ---", "Rouvel: 0.043140385 K/W")
print("r1_ow:", prj.list_of_buildings[0].thermal_zones[0].r1_ow, "K/W ---", "Rouvel: 0.004049352 K/W")
print("c1_ow: ", prj.list_of_buildings[0].thermal_zones[0].c1_ow / 1000, "kJ/K ---", "Rouvel: 47.9 kJ/K")
