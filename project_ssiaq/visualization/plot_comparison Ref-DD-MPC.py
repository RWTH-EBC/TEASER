...
if __name__ == '__main__':
    ...
    setup_name_3 = "20240310_reduced_scenarios"
    ...
    df2 = df2.replace(["multi_family_house", "single_family_house", "apartment_block", "terraced_house",
                       "school", "hotel", "office"], range(1,8))
    df3 = df3.replace(["multi_family_house", "single_family_house", "apartment_block", "terraced_house",
                       "school", "hotel", "office"], range(1,8))
    df1.set_index(df1["Scenario"],inplace=True)
    df2.set_index(df2["Scenario"],inplace=True)
