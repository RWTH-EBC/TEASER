...
setup(name='teaser',
      ...
      package_data={'teaser.data.input.inputdata': ['*.xml'],
                    'teaser.data.output.modelicatemplate': ['package',
                                                            'package_order'],
                    'teaser.data.output.modelicatemplate.AixLib': [
                        'AixLib_base', 'AixLib_model', 'AixLib_zone'],
                    'teaser.data.output.modelicatemplate.Annex60': [
                        'Annex60_FourElements', 'Annex60_ThreeElements',
                        'Annex60_TwoElements'],
      ...
      setup_requires=['mako', 'pyxb==1.2.4', 'pytest', 'scipy', 'numpy'],
      install_requires=['mako', 'pyxb==1.2.4', 'pytest', 'scipy', 'numpy'])
