...
#test for U-value for retrofit
    ...
    def test_tabula_uvalue_retrofit_sfh_dk_1997(self):
        prj.add_residential(
            ...
            number_of_floors=1,
            height_of_floors=3.2,
            net_leased_area=122, construction_data="tabula_retrofit")
...
#----------------------------------------------------------------------------------
    ...
    def test_tabula_uvalue_retrofit_sfh_dk_1977(self):
        prj.add_residential(
            ...
            number_of_floors=1,
            height_of_floors=3.2,
            net_leased_area=117, construction_data="tabula_retrofit")
...
#----------------------------------------------------------------------------------
    ...
    def test_tabula_uvalue_retrofit_sfh_dk_1971(self):
        prj.add_residential(
            ...
            number_of_floors=1,
            height_of_floors=3.2,
            net_leased_area=153, construction_data="tabula_retrofit")
...
#----------------------------------------------------------------------------------
    ...
    def test_tabula_uvalue_retrofit_sfh_dk_1959(self):
        prj.add_residential(
            ...
            number_of_floors=2,
            height_of_floors=3.2,
            net_leased_area=90, construction_data="tabula_retrofit")
...
#----------------------------------------------------------------------------------
    ...
    def test_tabula_uvalue_retrofit_sfh_dk_1949(self):
        prj.add_residential(
            ...
            number_of_floors=2,
            height_of_floors=3.2,
            net_leased_area=119, construction_data="tabula_retrofit")
...
#----------------------------------------------------------------------------------
    ...
    def test_tabula_uvalue_retrofit_sfh_dk_1929(self):
        prj.add_residential(
            ...
            number_of_floors=2,
            height_of_floors=3.2,
            net_leased_area=95, construction_data="tabula_retrofit")
...
#----------------------------------------------------------------------------------
    ...
    def test_tabula_uvalue_retrofit_sfh_dk_1849(self):
        prj.add_residential(
            ...
            number_of_floors=1,
            height_of_floors=3.2,
            net_leased_area=132, construction_data="tabula_retrofit")
...
#U-value adv retrofit
    ...
    def test_tabula_uvalue_adv_retrofit_sfh_dk_1997(self):
        prj.add_residential(
            ...
            number_of_floors=1,
            height_of_floors=3.2,
            net_leased_area=122, construction_data="tabula_adv_retrofit")
...
#----------------------------------------------------------------------------------
    ...
    def test_tabula_uvalue_adv_retrofit_sfh_dk_1977(self):
        prj.add_residential(
            ...
            number_of_floors=1,
            height_of_floors=3.2,
            net_leased_area=117, construction_data="tabula_adv_retrofit")
...
#----------------------------------------------------------------------------------
    ...
    def test_tabula_uvalue_adv_retrofit_sfh_dk_1971(self):
        prj.add_residential(
            ...
            number_of_floors=1,
            height_of_floors=3.2,
            net_leased_area=153, construction_data="tabula_adv_retrofit")
...
#----------------------------------------------------------------------------------
    ...
    def test_tabula_uvalue_adv_retrofit_sfh_dk_1959(self):
        prj.add_residential(
            ...
            number_of_floors=2,
            height_of_floors=3.2,
            net_leased_area=90, construction_data="tabula_adv_retrofit")
...
#----------------------------------------------------------------------------------
    ...
    def test_tabula_uvalue_adv_retrofit_sfh_dk_1949(self):
        prj.add_residential(
            ...
            number_of_floors=2,
            height_of_floors=3.2,
            net_leased_area=119, construction_data="tabula_adv_retrofit")
...
#----------------------------------------------------------------------------------
    ...
    def test_tabula_uvalue_adv_retrofit_sfh_dk_1929(self):
        prj.add_residential(
            ...
            number_of_floors=2,
            height_of_floors=3.2,
            net_leased_area=95, construction_data="tabula_adv_retrofit")
...
#----------------------------------------------------------------------------------
    ...
    def test_tabula_uvalue_adv_retrofit_sfh_dk_1849(self):
        prj.add_residential(
            ...
            number_of_floors=1,
            height_of_floors=3.2,
            net_leased_area=132, construction_data="tabula_adv_retrofit")
