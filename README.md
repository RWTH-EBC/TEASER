...
TEASER (Tool for Energy Analysis and Simulation for Efficient Retrofit) allows a
...
The current version is 0.5, which is a pre-release.
...
If you actively want to develop TEASER you can clone this repository by using:
...
### Dependencies
 ...
 recommended as they already contain (or easily support installation) many
...
packages (e.g. SciPy, NumPy, pip, PyQT, etc.) that are used in the code.
